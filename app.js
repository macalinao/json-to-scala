...
function $is_Lpw_ian_jsontoscala_Type(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lpw_ian_jsontoscala_Type)))
}
function $as_Lpw_ian_jsontoscala_Type(obj) {
  return (($is_Lpw_ian_jsontoscala_Type(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "pw.ian.jsontoscala.Type"))
}
function $isArrayOf_Lpw_ian_jsontoscala_Type(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lpw_ian_jsontoscala_Type)))
}
function $asArrayOf_Lpw_ian_jsontoscala_Type(obj, depth) {
  return (($isArrayOf_Lpw_ian_jsontoscala_Type(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lpw.ian.jsontoscala.Type;", depth))
}
/** @constructor */
function $c_O() {
  /*<skip>*/
...
/** @constructor */
function $c_Lpw_ian_jsontoscala_App$() {
  $c_O.call(this)
}
$c_Lpw_ian_jsontoscala_App$.prototype = new $h_O();
$c_Lpw_ian_jsontoscala_App$.prototype.constructor = $c_Lpw_ian_jsontoscala_App$;
/** @constructor */
function $h_Lpw_ian_jsontoscala_App$() {
  /*<skip>*/
}
$h_Lpw_ian_jsontoscala_App$.prototype = $c_Lpw_ian_jsontoscala_App$.prototype;
$c_Lpw_ian_jsontoscala_App$.prototype.init___ = (function() {
  return this
});
$c_Lpw_ian_jsontoscala_App$.prototype.doConvert__T__T__V = (function(source, dest) {
  var src = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById(source);
  var tgt = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById(dest);
  var classes = $m_Lpw_ian_jsontoscala_JSONToScala$().convert__T__sci_List($as_T(src.value));
  if (($s_sc_LinearSeqOptimized$class__length__sc_LinearSeqOptimized__I(classes) > 0)) {
    if (classes.isEmpty__Z()) {
      var jsx$1;
      throw new $c_jl_UnsupportedOperationException().init___T("empty.reduceLeft")
    } else {
      var this$1 = classes.tail__sci_List();
      var z = classes.head__O();
      var acc = z;
      var these = this$1;
      while ((!these.isEmpty__Z())) {
        var arg1 = acc;
    ...
    tgt.innerHTML = $as_T(jsx$1)
  } else {
    tgt.innerHTML = "No classes found"
  }
});
$c_Lpw_ian_jsontoscala_App$.prototype.$$js$exported$meth$doConvert__T__T__O = (function(source, dest) {
  this.doConvert__T__T__V(source, dest)
});
$c_Lpw_ian_jsontoscala_App$.prototype.doConvert = (function(arg$1, arg$2) {
  var prep0 = $as_T(arg$1);
  var prep1 = $as_T(arg$2);
  return this.$$js$exported$meth$doConvert__T__T__O(prep0, prep1)
});
var $d_Lpw_ian_jsontoscala_App$ = new $TypeData().initClass({
  Lpw_ian_jsontoscala_App$: 0
}, false, "pw.ian.jsontoscala.App$", {
  Lpw_ian_jsontoscala_App$: 1,
  O: 1
});
$c_Lpw_ian_jsontoscala_App$.prototype.$classData = $d_Lpw_ian_jsontoscala_App$;
var $n_Lpw_ian_jsontoscala_App$ = (void 0);
function $m_Lpw_ian_jsontoscala_App$() {
  if ((!$n_Lpw_ian_jsontoscala_App$)) {
    $n_Lpw_ian_jsontoscala_App$ = new $c_Lpw_ian_jsontoscala_App$().init___()
  };
  return $n_Lpw_ian_jsontoscala_App$
}
$e.pw = ($e.pw || {});
$e.pw.ian = ($e.pw.ian || {});
$e.pw.ian.jsontoscala = ($e.pw.ian.jsontoscala || {});
$e.pw.ian.jsontoscala.App = $m_Lpw_ian_jsontoscala_App$;
/** @constructor */
function $c_Lpw_ian_jsontoscala_JSONToScala$() {
  $c_O.call(this)
}
$c_Lpw_ian_jsontoscala_JSONToScala$.prototype = new $h_O();
$c_Lpw_ian_jsontoscala_JSONToScala$.prototype.constructor = $c_Lpw_ian_jsontoscala_JSONToScala$;
/** @constructor */
function $h_Lpw_ian_jsontoscala_JSONToScala$() {
  /*<skip>*/
}
$h_Lpw_ian_jsontoscala_JSONToScala$.prototype = $c_Lpw_ian_jsontoscala_JSONToScala$.prototype;
$c_Lpw_ian_jsontoscala_JSONToScala$.prototype.init___ = (function() {
  return this
});
$c_Lpw_ian_jsontoscala_JSONToScala$.prototype.convert__T__sci_List = (function(json) {
  var obj = $g.JSON.parse(json);
  var this$2 = new $c_Lpw_ian_jsontoscala_TypeFinder().init___sjs_js_Any(obj).findTypes__sci_List();
  var f = (function(x$6$2) {
    var x$6 = $as_Lpw_ian_jsontoscala_DictType(x$6$2);
    return x$6.toCaseClass__T()
  });
...
var $d_Lpw_ian_jsontoscala_JSONToScala$ = new $TypeData().initClass({
  Lpw_ian_jsontoscala_JSONToScala$: 0
}, false, "pw.ian.jsontoscala.JSONToScala$", {
  Lpw_ian_jsontoscala_JSONToScala$: 1,
  O: 1
});
$c_Lpw_ian_jsontoscala_JSONToScala$.prototype.$classData = $d_Lpw_ian_jsontoscala_JSONToScala$;
var $n_Lpw_ian_jsontoscala_JSONToScala$ = (void 0);
function $m_Lpw_ian_jsontoscala_JSONToScala$() {
  if ((!$n_Lpw_ian_jsontoscala_JSONToScala$)) {
    $n_Lpw_ian_jsontoscala_JSONToScala$ = new $c_Lpw_ian_jsontoscala_JSONToScala$().init___()
  };
  return $n_Lpw_ian_jsontoscala_JSONToScala$
}
/** @constructor */
function $c_Lpw_ian_jsontoscala_TypeFinder() {
  $c_O.call(this);
  this.obj$1 = null;
  this.types$1 = null
}
$c_Lpw_ian_jsontoscala_TypeFinder.prototype = new $h_O();
$c_Lpw_ian_jsontoscala_TypeFinder.prototype.constructor = $c_Lpw_ian_jsontoscala_TypeFinder;
/** @constructor */
function $h_Lpw_ian_jsontoscala_TypeFinder() {
  /*<skip>*/
}
$h_Lpw_ian_jsontoscala_TypeFinder.prototype = $c_Lpw_ian_jsontoscala_TypeFinder.prototype;
$c_Lpw_ian_jsontoscala_TypeFinder.prototype.maybeRegister__Lpw_ian_jsontoscala_Type__Lpw_ian_jsontoscala_Type = (function(t) {
  if ($is_Lpw_ian_jsontoscala_DictType(t)) {
    var d = $as_Lpw_ian_jsontoscala_DictType(t);
    var this$1 = this.types$1;
    inlinereturn$1: {
      var these = this$1;
      while ((!these.isEmpty__Z())) {
        var arg1 = these.head__O();
        var x$5 = $as_Lpw_ian_jsontoscala_DictType(arg1);
        if (((x$5 === null) ? (d === null) : x$5.equals__O__Z(d))) {
          var x1 = new $c_s_Some().init___O(these.head__O());
    ...
    if ((!$is_s_Some(x1))) {
      var this$2 = this.types$1;
      this.types$1 = new $c_sci_$colon$colon().init___O__sci_List(d, this$2)
    }
  };
  return t
});
$c_Lpw_ian_jsontoscala_TypeFinder.prototype.capitalize__T__T = (function(s) {
  var c = (65535 & $uI(s.charCodeAt(0)));
  var c$1 = $m_jl_Character$().toUpperCase__C__C(c);
  return (("" + new $c_jl_Character().init___C(c$1)) + $as_T(s.substring(1)))
});
$c_Lpw_ian_jsontoscala_TypeFinder.prototype.findTypes__sci_List = (function() {
  this.maybeRegister__Lpw_ian_jsontoscala_Type__Lpw_ian_jsontoscala_Type(this.findType__T__O__Lpw_ian_jsontoscala_Type("Thing", this.obj$1));
  return this.types$1
});
$c_Lpw_ian_jsontoscala_TypeFinder.prototype.init___sjs_js_Any = (function(obj) {
  this.obj$1 = obj;
  this.types$1 = $m_sci_Nil$();
  return this
});
$c_Lpw_ian_jsontoscala_TypeFinder.prototype.findType__T__O__Lpw_ian_jsontoscala_Type = (function(key, obj) {
    ...
    var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
      return (function(x0$2$2) {
        ...
        if ((x0$2 !== null)) {
          ...
          var value = x0$2.$$und2__O();
          return new $c_T2().init___O__O(key$1, arg$outer.findType__T__O__Lpw_ian_jsontoscala_Type(key$1, value))
        } else {
...
var $d_Lpw_ian_jsontoscala_TypeFinder = new $TypeData().initClass({
  Lpw_ian_jsontoscala_TypeFinder: 0
}, false, "pw.ian.jsontoscala.TypeFinder", {
  Lpw_ian_jsontoscala_TypeFinder: 1,
  O: 1
});
$c_Lpw_ian_jsontoscala_TypeFinder.prototype.$classData = $d_Lpw_ian_jsontoscala_TypeFinder;
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
  this.data$1 = null
...
/** @constructor */
function $c_Lpw_ian_jsontoscala_ArrayType() {
  $c_O.call(this);
  this.typeObj$1 = null
}
$c_Lpw_ian_jsontoscala_ArrayType.prototype = new $h_O();
$c_Lpw_ian_jsontoscala_ArrayType.prototype.constructor = $c_Lpw_ian_jsontoscala_ArrayType;
/** @constructor */
function $h_Lpw_ian_jsontoscala_ArrayType() {
  /*<skip>*/
}
$h_Lpw_ian_jsontoscala_ArrayType.prototype = $c_Lpw_ian_jsontoscala_ArrayType.prototype;
$c_Lpw_ian_jsontoscala_ArrayType.prototype.productPrefix__T = (function() {
  return "ArrayType"
});
$c_Lpw_ian_jsontoscala_ArrayType.prototype.productArity__I = (function() {
  return 1
});
$c_Lpw_ian_jsontoscala_ArrayType.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lpw_ian_jsontoscala_ArrayType(x$1)) {
    var ArrayType$1 = $as_Lpw_ian_jsontoscala_ArrayType(x$1);
    var x = this.typeObj$1;
    var x$2 = ArrayType$1.typeObj$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lpw_ian_jsontoscala_ArrayType.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.typeObj$1;
      break
    }
    default: {
      throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
...
$c_Lpw_ian_jsontoscala_ArrayType.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lpw_ian_jsontoscala_ArrayType.prototype.name__T = (function() {
  return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["List[", "]"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.typeObj$1.name__T()]))
});
$c_Lpw_ian_jsontoscala_ArrayType.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lpw_ian_jsontoscala_ArrayType.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lpw_ian_jsontoscala_ArrayType.prototype.init___Lpw_ian_jsontoscala_Type = (function(typeObj) {
  this.typeObj$1 = typeObj;
  return this
});
function $is_Lpw_ian_jsontoscala_ArrayType(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lpw_ian_jsontoscala_ArrayType)))
}
function $as_Lpw_ian_jsontoscala_ArrayType(obj) {
  return (($is_Lpw_ian_jsontoscala_ArrayType(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "pw.ian.jsontoscala.ArrayType"))
}
function $isArrayOf_Lpw_ian_jsontoscala_ArrayType(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lpw_ian_jsontoscala_ArrayType)))
}
function $asArrayOf_Lpw_ian_jsontoscala_ArrayType(obj, depth) {
  return (($isArrayOf_Lpw_ian_jsontoscala_ArrayType(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lpw.ian.jsontoscala.ArrayType;", depth))
}
var $d_Lpw_ian_jsontoscala_ArrayType = new $TypeData().initClass({
  Lpw_ian_jsontoscala_ArrayType: 0
}, false, "pw.ian.jsontoscala.ArrayType", {
  Lpw_ian_jsontoscala_ArrayType: 1,
  O: 1,
  Lpw_ian_jsontoscala_Type: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
});
$c_Lpw_ian_jsontoscala_ArrayType.prototype.$classData = $d_Lpw_ian_jsontoscala_ArrayType;
/** @constructor */
function $c_Lpw_ian_jsontoscala_DictType() {
  $c_O.call(this);
  this.name$1 = null;
  this.fields$1 = null
}
$c_Lpw_ian_jsontoscala_DictType.prototype = new $h_O();
$c_Lpw_ian_jsontoscala_DictType.prototype.constructor = $c_Lpw_ian_jsontoscala_DictType;
/** @constructor */
function $h_Lpw_ian_jsontoscala_DictType() {
  /*<skip>*/
}
$h_Lpw_ian_jsontoscala_DictType.prototype = $c_Lpw_ian_jsontoscala_DictType.prototype;
$c_Lpw_ian_jsontoscala_DictType.prototype.productPrefix__T = (function() {
  return "DictType"
});
$c_Lpw_ian_jsontoscala_DictType.prototype.productArity__I = (function() {
  return 2
});
$c_Lpw_ian_jsontoscala_DictType.prototype.equals__O__Z = (function(other) {
  if ($is_Lpw_ian_jsontoscala_DictType(other)) {
    var x2 = $as_Lpw_ian_jsontoscala_DictType(other);
    var this$1 = this.fields$1;
    var array = [new $c_sci_MapLike$ImmutableDefaultKeySet().init___sci_MapLike(this$1)];
    ...
    var this$3 = x2.fields$1;
    var array$1 = [new $c_sci_MapLike$ImmutableDefaultKeySet().init___sci_MapLike(this$3)];
    if (($uI(array$1.length) === 0)) {
      var x$2 = $m_sci_Set$EmptySet$()
    } else {
...
$c_Lpw_ian_jsontoscala_DictType.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.name$1;
      break
...
$c_Lpw_ian_jsontoscala_DictType.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lpw_ian_jsontoscala_DictType.prototype.name__T = (function() {
  return this.name$1
});
$c_Lpw_ian_jsontoscala_DictType.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lpw_ian_jsontoscala_DictType.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lpw_ian_jsontoscala_DictType.prototype.init___T__sci_Map = (function(name, fields) {
  this.name$1 = name;
...
$c_Lpw_ian_jsontoscala_DictType.prototype.toCaseClass__T = (function() {
  ...
  var this$2 = $m_sci_List$();
  var cbf = this$2.ReusableCBFInstance$2;
  var this$4 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(this$1, cbf));
  var f = (function(x0$1$2) {
    var x0$1 = $as_T2(x0$1$2);
    if ((x0$1 !== null)) {
      var key = $as_T(x0$1.$$und1__O());
      var t = $as_Lpw_ian_jsontoscala_Type(x0$1.$$und2__O());
      return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["  ", ": ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([key, t.name__T()]))
    } else {
      throw new $c_s_MatchError().init___O(x0$1)
    }
  });
  ...
  var this$7 = $as_sc_TraversableOnce(jsx$1);
  var op = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(x$1$2, x$2$2) {
    var x$1 = $as_T(x$1$2);
    var x$2 = $as_T(x$2$2);
    return ((x$1 + ",\n") + x$2)
  }));
  ...
  if (this$10.isEmpty__Z()) {
    ...
    var this$11 = this$10.tail__sci_List();
    var z = this$10.head__O();
    var acc = z;
    var these$1 = this$11;
...
function $is_Lpw_ian_jsontoscala_DictType(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lpw_ian_jsontoscala_DictType)))
}
function $as_Lpw_ian_jsontoscala_DictType(obj) {
  return (($is_Lpw_ian_jsontoscala_DictType(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "pw.ian.jsontoscala.DictType"))
}
function $isArrayOf_Lpw_ian_jsontoscala_DictType(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lpw_ian_jsontoscala_DictType)))
}
function $asArrayOf_Lpw_ian_jsontoscala_DictType(obj, depth) {
  return (($isArrayOf_Lpw_ian_jsontoscala_DictType(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lpw.ian.jsontoscala.DictType;", depth))
}
var $d_Lpw_ian_jsontoscala_DictType = new $TypeData().initClass({
  Lpw_ian_jsontoscala_DictType: 0
}, false, "pw.ian.jsontoscala.DictType", {
  Lpw_ian_jsontoscala_DictType: 1,
  O: 1,
  Lpw_ian_jsontoscala_Type: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lpw_ian_jsontoscala_DictType.prototype.$classData = $d_Lpw_ian_jsontoscala_DictType;
/** @constructor */
function $c_Lpw_ian_jsontoscala_NamedType() {
  $c_O.call(this);
  this.name$1 = null
}
$c_Lpw_ian_jsontoscala_NamedType.prototype = new $h_O();
$c_Lpw_ian_jsontoscala_NamedType.prototype.constructor = $c_Lpw_ian_jsontoscala_NamedType;
/** @constructor */
function $h_Lpw_ian_jsontoscala_NamedType() {
  /*<skip>*/
}
$h_Lpw_ian_jsontoscala_NamedType.prototype = $c_Lpw_ian_jsontoscala_NamedType.prototype;
$c_Lpw_ian_jsontoscala_NamedType.prototype.productPrefix__T = (function() {
  return "NamedType"
});
$c_Lpw_ian_jsontoscala_NamedType.prototype.productArity__I = (function() {
  return 1
});
$c_Lpw_ian_jsontoscala_NamedType.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lpw_ian_jsontoscala_NamedType(x$1)) {
    var NamedType$1 = $as_Lpw_ian_jsontoscala_NamedType(x$1);
    return (this.name$1 === NamedType$1.name$1)
  } else {
    return false
  }
});
$c_Lpw_ian_jsontoscala_NamedType.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.name$1;
      break
...
$c_Lpw_ian_jsontoscala_NamedType.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lpw_ian_jsontoscala_NamedType.prototype.name__T = (function() {
  return this.name$1
});
$c_Lpw_ian_jsontoscala_NamedType.prototype.init___T = (function(name) {
  this.name$1 = name;
  return this
});
$c_Lpw_ian_jsontoscala_NamedType.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lpw_ian_jsontoscala_NamedType.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lpw_ian_jsontoscala_NamedType(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lpw_ian_jsontoscala_NamedType)))
}
function $as_Lpw_ian_jsontoscala_NamedType(obj) {
  return (($is_Lpw_ian_jsontoscala_NamedType(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "pw.ian.jsontoscala.NamedType"))
}
function $isArrayOf_Lpw_ian_jsontoscala_NamedType(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lpw_ian_jsontoscala_NamedType)))
}
function $asArrayOf_Lpw_ian_jsontoscala_NamedType(obj, depth) {
  return (($isArrayOf_Lpw_ian_jsontoscala_NamedType(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lpw.ian.jsontoscala.NamedType;", depth))
}
var $d_Lpw_ian_jsontoscala_NamedType = new $TypeData().initClass({
  Lpw_ian_jsontoscala_NamedType: 0
}, false, "pw.ian.jsontoscala.NamedType", {
  Lpw_ian_jsontoscala_NamedType: 1,
  O: 1,
  Lpw_ian_jsontoscala_Type: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lpw_ian_jsontoscala_NamedType.prototype.$classData = $d_Lpw_ian_jsontoscala_NamedType;
/** @constructor */
function $c_T2() {
  $c_O.call(this);
  this.$$und1$f = null;
...
//# sourceMappingURL=jsontoscala-fastopt.js.map
